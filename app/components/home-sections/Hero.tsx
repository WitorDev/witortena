...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className={`${ubuntuMonoFont.className} mx-auto relative sm:px-4 pt-34 sm:pt-62 pb-12 sm:pb-42 overflow-hidden flex flex-col justify-center items-center text-center`}
    >
      {/* {isAtTop && (
        <motion.div
